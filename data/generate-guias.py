...
UI = {
    'pt': dict(
        ...
        tr_seg=lambda p: ['Segurança (criminalidade)', f'{sv(p["seg_val"],"pt")} crimes/1 000 hab', f'{p["seg"]}/100', 'INE 2023'],
        tr_geral=lambda p: ['Qualidade de vida global', '—', f'{p["score"]}/100', 'Melhor Zona'],
        ...
        footer_data='Dados: INE Censos 2021 · INE 2024 · Actualizado em junho de 2026',
        privacy='Privacidade',
    ...
    'br': dict(
        ...
        tr_seg=lambda p: ['Segurança (criminalidade)', f'{sv(p["seg_val"],"br")} crimes/1.000 hab', f'{p["seg"]}/100', 'INE 2023'],
        tr_geral=lambda p: ['Qualidade de vida global', '—', f'{p["score"]}/100', 'Melhor Zona'],
        ...
        footer_copy='Qualidade de vida por freguesia em Portugal',
        footer_data='Dados: INE Censos 2021 · INE 2024 · Atualizado em junho de 2026',
        privacy='Privacidade',
    ...
    'en': dict(
        ...
        tr_seg=lambda p: ['Safety (crime rate)', f'{sv(p["seg_val"],"en")} crimes/1,000 residents', f'{p["seg"]}/100', 'INE 2023'],
        tr_geral=lambda p: ['Overall quality of life', '—', f'{p["score"]}/100', 'Melhor Zona'],
        ...
        footer_data='Data: INE Census 2021 · INE 2024 · Updated June 2026',
        privacy='Privacy',
